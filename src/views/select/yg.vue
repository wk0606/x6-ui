<template>
  <div>
    <div>
      <x-select type="yg" v-model="form.ygid" :addable="true" :editable="true"  />
      <el-button @click="showForm">click</el-button>
    </div>
    <br/><br>
    <div>
      <h3>此组件继承自XSelect，对应的type为 ‘yg’</h3><br/>
      <p>属性说明</p>
      ...
      <p>text: 员工名称，仅在editable为false生效</p>
      <p style="color: red;">注: 组件值采用v-model绑定，绑定的为员工id，请知晓</p>
    </div>
  </div>
</template>
<script>
