<template>
  <div>
    <div>
      <x-select type="zh" v-model="form.zhdm" :addable="true" :editable="true" />
      <el-button @click="showForm">click</el-button>
    </div>
    <br/><br>
    <div>
      <h3>此组件继承自XSelect，对应的type为 ‘zh’</h3><br/>
      <p>属性说明</p>
      ...
      <p>text: 账户名称，仅在editable为false生效</p>
      <p style="color: red;">注: 组件值采用v-model绑定，绑定的为账户id，请知晓</p>
    </div>
  </div>
</template>
<script>
